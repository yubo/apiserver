...
// ConfigToExecCluster creates a clientauthentication.Cluster with the corresponding fields from
// the provided Config.
func ConfigToExecCluster(config *Config) (*clientauthentication.Cluster, error) {
...
// clientauthentication.Cluster. The returned Config will be anonymous (i.e., it will not have
