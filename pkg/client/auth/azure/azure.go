...
func init() {
	if err := client.RegisterAuthProviderPlugin("azure", newAzureAuthProvider); err != nil {
...
func newAzureAuthProvider(_ string, cfg map[string]string, persister client.AuthProviderConfigPersister) (client.AuthProvider, error) {
	var (
		ts          tokenSource
...
type azureTokenSource struct {
	...
	persister  client.AuthProviderConfigPersister
}

func newAzureTokenSource(source tokenSource, cache *azureTokenCache, cfg map[string]string, configMode configMode, persister client.AuthProviderConfigPersister) tokenSource {
