...
func init() {
	if err := client.RegisterAuthProviderPlugin("gcp", newGCPAuthProvider); err != nil {
...
func newGCPAuthProvider(_ string, gcpConfig map[string]string, persister client.AuthProviderConfigPersister) (client.AuthProvider, error) {
...
func newCachedTokenSource(accessToken, expiry string, persister client.AuthProviderConfigPersister, ts oauth2.TokenSource, cache map[string]string) (*cachedTokenSource, error) {
