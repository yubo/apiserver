...
func NewDeprecatedCertificateRoundTripperWrapperConstructor(missingSAN, sha1 prometheus.Counter) func(rt http.RoundTripper) http.RoundTripper {
...
func NewSANDeprecatedChecker(counter prometheus.Counter) *missingSANChecker {
...
func NewSHA1SignatureDeprecatedChecker(counter prometheus.Counter) *sha1SignatureChecker {
