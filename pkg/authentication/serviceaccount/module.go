...
func Register(opts ...proc.ModuleOption) {
	module := &authModule{name: moduleName}
	hookOps := []v1.HookOps{{
		Hook:        module.init,
		Owner:       moduleName,
