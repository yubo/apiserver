...
type Executor interface {
	...
	ExecInContainer(name string, uid types.UID, container string, cmd []string, in io.Reader, out, err io.WriteCloser, tty bool, resize <-chan term.TerminalSize, timeout time.Duration) error
}
