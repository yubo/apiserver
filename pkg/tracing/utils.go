...
func HTTPStart(w http.ResponseWriter, req *http.Request, name string, attributes ...attribute.KeyValue) (context.Context, *Span) {
	ctx, span := Start(req.Context(), name, attributes...)
	req.WithContext(ctx)
	return ctx, span
}
