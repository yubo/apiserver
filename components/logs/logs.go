...
// github.com/yubo/apiserver/components/cli/flag/WordSepNormalizeFunc as normalization
...
//     github.com/yubo/apiserver/components/logs/example/cmd demonstrates how to do that
func InitLogs() {
