...
// List of logs (k8s.io/klog + github.com/yubo/apiserver/components/logs) flags supported by all logging formats
...
func unsupportedLoggingFlags(normalizeFunc func(f *pflag.FlagSet, name string) pflag.NormalizedName) []*pflag.Flag {
	// github.com/yubo/apiserver/components/logs and klog flags
	pfs := &pflag.FlagSet{}
