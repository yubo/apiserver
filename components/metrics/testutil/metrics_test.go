...
func TestLabelsMatch(t *testing.T) {
	cases := []struct {
		...
		{name: "metric labels and labelFilter have the same labels and values", metric: &dto.Metric{
			Label: []*dto.LabelPair{
				{Name: util.String("a"), Value: util.String("1")},
				{Name: util.String("b"), Value: util.String("2")},
				{Name: util.String("c"), Value: util.String("3")},
			}}, labelFilter: map[string]string{
			"a": "1",
			"b": "2",
			"c": "3",
		...
		{name: "The intersection of metric labels and labelFilter labels is empty", metric: &dto.Metric{
			Label: []*dto.LabelPair{
				{Name: util.String("aa"), Value: util.String("11")},
				{Name: util.String("bb"), Value: util.String("22")},
				{Name: util.String("cc"), Value: util.String("33")},
			}}, labelFilter: map[string]string{
			"a": "1",
			"b": "2",
			"c": "3",
		...
		{name: "metric labels contain label name but different values with labelFilter labels and value", metric: &dto.Metric{
			Label: []*dto.LabelPair{
				{Name: util.String("a"), Value: util.String("1")},
				{Name: util.String("b"), Value: util.String("2")},
				{Name: util.String("c"), Value: util.String("33")},
				{Name: util.String("d"), Value: util.String("4")},
			}}, labelFilter: map[string]string{
			"a": "1",
			"b": "2",
			"c": "3",
...
func TestHistogramVec_GetAggregatedSampleCount(t *testing.T) {
	tests := []struct {
		...
		},
		{
			name: "zero case",
			vec: HistogramVec{
				&Histogram{&dto.Histogram{SampleCount: uint64Ptr(0), SampleSum: util.Float64(0.0)}},
			},
			want: 0,
		},
		{
			name: "standard case",
			vec: HistogramVec{
				&Histogram{&dto.Histogram{SampleCount: uint64Ptr(1), SampleSum: util.Float64(2.0)}},
				&Histogram{&dto.Histogram{SampleCount: uint64Ptr(2), SampleSum: util.Float64(4.0)}},
				&Histogram{&dto.Histogram{SampleCount: uint64Ptr(4), SampleSum: util.Float64(8.0)}},
			},
			want: 7,
		},
		{
...
func TestHistogramVec_Validate(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			name: "nil SampleCount",
			vec: HistogramVec{
				&Histogram{&dto.Histogram{SampleCount: uint64Ptr(1), SampleSum: util.Float64(1.0)}},
				&Histogram{&dto.Histogram{SampleSum: util.Float64(2.0)}},
			},
		...
		},
		{
			...
			vec: HistogramVec{
				&Histogram{&dto.Histogram{SampleCount: uint64Ptr(1), SampleSum: util.Float64(1.0)}},
				&Histogram{&dto.Histogram{SampleCount: uint64Ptr(2), SampleSum: util.Float64(2.0)}},
			},
		},
		{
			...
			vec: HistogramVec{
				&Histogram{&dto.Histogram{
					...
					SampleSum:   util.Float64(10.0),
					Bucket: []*dto.Bucket{
						{CumulativeCount: uint64Ptr(1), UpperBound: util.Float64(1)},
						{CumulativeCount: uint64Ptr(2), UpperBound: util.Float64(2)},
						{CumulativeCount: uint64Ptr(5), UpperBound: util.Float64(4)},
					},
				}},
				&Histogram{&dto.Histogram{
					SampleCount: uint64Ptr(3),
					SampleSum:   util.Float64(8.0),
					Bucket: []*dto.Bucket{
						{CumulativeCount: uint64Ptr(1), UpperBound: util.Float64(2)},
						{CumulativeCount: uint64Ptr(3), UpperBound: util.Float64(4)},
					},
				}},
			},
	...
	tests := []struct {
	...
	}{
		{
			...
			wantVec: HistogramVec{
				&Histogram{&dto.Histogram{
					SampleCount: uint64Ptr(1),
					SampleSum:   util.Float64(1.5),
					Bucket: []*dto.Bucket{
						{CumulativeCount: uint64Ptr(0), UpperBound: util.Float64(0.5)},
						{CumulativeCount: uint64Ptr(1), UpperBound: util.Float64(2.0)},
						{CumulativeCount: uint64Ptr(1), UpperBound: util.Float64(5.0)},
					},
				}},
				&Histogram{&dto.Histogram{
					SampleCount: uint64Ptr(1),
					SampleSum:   util.Float64(2.5),
					Bucket: []*dto.Bucket{
						{CumulativeCount: uint64Ptr(0), UpperBound: util.Float64(0.5)},
						{CumulativeCount: uint64Ptr(0), UpperBound: util.Float64(2.0)},
						{CumulativeCount: uint64Ptr(1), UpperBound: util.Float64(5.0)},
					},
				}},
			},
