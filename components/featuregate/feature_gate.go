...
import (
	...
	"github.com/yubo/golib/util/naming"

	featuremetrics "github.com/yubo/apiserver/components/metrics/prometheus/feature"
	"k8s.io/klog/v2"
)
...
var internalPackages = []string{"github.com/yubo/apiserver/components/featuregate/feature_gate.go"}
