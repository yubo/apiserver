...
//	"time"
//
//	eventsv1 "github.com/yubo/apiserver/pkg/apis/events/v1"
//	"github.com/yubo/apiserver/pkg/types"
//	"github.com/yubo/apiserver/tools/record"
...
//	regarding           api.ObjectReference
//	related             api.ObjectReference
//}
//
//type eventBroadcasterImpl struct {
//	*watch.Broadcaster
//	mu            sync.Mutex
//	eventCache    map[eventKey]*api.Event
...
//	}
//	return e.Interface.Events(event.Namespace).Create(context.TODO(), event, api.CreateOptions{})
//}
//
...
//	}
//	return e.Interface.Events(event.Namespace).Update(context.TODO(), event, api.UpdateOptions{})
//}
//
...
//	}
//	return e.Interface.Events(event.Namespace).Patch(context.TODO(), event.Name, types.StrategicMergePatchType, data, api.PatchOptions{})
//}
//
...
//					isomorphicEvent.Series.LastObservedTime = api.MicroTime{Time: clock.Now()}
//					return nil
//				}
//				isomorphicEvent.Series = &eventsv1.EventSeries{
//					Count:            1,
//					LastObservedTime: api.MicroTime{Time: clock.Now()},
//				}
...
//	if _, err := client.Discovery().ServerResourcesForGroupVersion(); err == nil {
...
//	return e.coreBroadcaster.NewRecorder(scheme.Scheme, api.EventSource{Component: name})
//}
//
