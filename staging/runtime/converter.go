...
func decodeParameters(parameters *Parameters, into Object) error {
	if parameters == nil {
		return nil
	}
...
func setFieldValue(p *Parameters, f *field, dstValue reflect.Value) error {
	var data []string
	var value string
	var ok bool
...
func encodeParameters(obj Object) (*Parameters, error) {
...
func buildParameters(rb *restful.RouteBuilder, obj Object) {
	rv := reflect.Indirect(reflect.ValueOf(obj))
	rt := rv.Type()
