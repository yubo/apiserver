...
// +genclient
// +genclient:method=CreateToken,verb=create,subresource=token,input=github.com/yubo/apiserver/staging/api/authentication/v1.TokenRequest,result=github.com/yubo/apiserver/staging/api/authentication/v1.TokenRequest
// +k8s:deepcopy-gen:interfaces=github.com/yubo/apiserver/staging/runtime.Object
