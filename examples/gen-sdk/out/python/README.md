...
*UserApi* | [**create_user**](docs/UserApi.md#create_user) | **POST** /api/user | create user
*UserApi* | [**delete_user**](docs/UserApi.md#delete_user) | **DELETE** /api/user/{user-name} | delete user
*UserApi* | [**get_user**](docs/UserApi.md#get_user) | **GET** /api/user/{user-name} | get user
*UserApi* | [**get_users**](docs/UserApi.md#get_users) | **GET** /api/user | search/list users
*UserApi* | [**update_user**](docs/UserApi.md#update_user) | **PUT** /api/user/{user-name} | update user
