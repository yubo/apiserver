...
func (s *grpcserver) GetUserV1(ctx context.Context, in *api.UserGetInput) (*api.User, error) {
	_, span := traces.Start(ctx, "GetUserV1", oteltrace.WithAttributes(attribute.String("name", in.Name)))
	defer span.End()
...
func (s *grpcserver) GetUserV2(ctx context.Context, in *api.UserGetInput) (*api.User, error) {
	_, span := traces.Start(ctx, "GetUserV2", oteltrace.WithAttributes(attribute.String("name", in.Name)))
	defer span.End()
...
func (s *grpcserver) GetUserV3(ctx context.Context, in *api.UserGetInput) (*api.User, error) {
	_, span := traces.Start(ctx, "GetUserV3", oteltrace.WithAttributes(attribute.String("name", in.Name)))
	defer span.End()
